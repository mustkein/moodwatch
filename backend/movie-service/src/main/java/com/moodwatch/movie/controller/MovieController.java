...
public class MovieController {
    ...
    @GetMapping("/{tmdbId}")
    public ResponseEntity<ApiResponse<MovieDetailDto>> getDetail(@PathVariable long tmdbId) {
        return ResponseEntity.ok(ApiResponse.ok(movieService.getMovieDetail(tmdbId)));
    }
}
